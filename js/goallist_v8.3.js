...
bingoList[3] = [
  ...
  { name: "Defeat King Dodongo", jp: 'ã‚­ãƒ³ã‚°ãƒ‰ãƒ‰ãƒ³ã‚´æ’ƒç ´', types: ["dc"], subtypes: ["hearts"], child: "yes" },
...
bingoList[4] = [
  ...
  { name: "Ice Arrows", jp: 'æ°·ã®çŸ¢', types: ["fortress", "quiver"], child: "yes" },
...
bingoList[5] = [
  ...
  { name: "Beat Dodongo's Cavern", jp: 'ãƒ‰ãƒ‰ãƒ³ã‚´ã®æ´žçªŸã‚¯ãƒªã‚¢', types: ["dc", "fortress"], child: "yes" },
...
bingoList[8] = [
  ...
  { name: "Defeat Phantom Ganon", jp: 'ãƒ•ã‚¡ãƒ³ãƒˆãƒ ã‚¬ãƒŽãƒ³æ’ƒç ´', types: ["forest"], subtypes: ["hearts"], child: "yes" },
...
bingoList[9] = [
  ...
  { name: "Beat the Forest Temple", jp: 'æ£®ã®ç¥žæ®¿ã‚¯ãƒªã‚¢', types: ["forest"], subtypes: ["hearts"], child: "yes" },
...
bingoList[10] = [
  { name: "37th heart piece (Child Fortress)", jp: '37ç•ªç›®ã®ãƒãƒ¼ãƒˆã®ã‹ã‘ã‚‰(å­ä¾›ã®ã‚²ãƒ«ãƒ‰ã®ç ¦)', types: ["fortress"], subtypes: ["hearts"], child: "yes" },
  ...
  { name: "Forest Medallion", jp: 'æ£®ã®ãƒ¡ãƒ€ãƒ«', types: ["forest", "lightarrow", "atrade", "zl"], subtypes: ["hearts"], child: "yes" },
...
bingoList[13] = [
  { name: "Bombchu Bowling Heart Piece", jp: 'ãƒœãƒ ãƒãƒ¥ã‚¦ãƒœã‚¦ãƒªãƒ³ã‚°ã®ãƒãƒ¼ãƒˆã®ã‹ã‘ã‚‰', types: ["dc"], subtypes: ["hearts", "child2"], child: "yes" },
...
bingoList[14] = [
  { name: "All 4 Gerudo Valley area Skulltulas", jp: 'ã‚²ãƒ«ãƒ‰ã®è°·ã‚¨ãƒªã‚¢ã®é»„é‡‘ã®ã‚¹ã‚¿ãƒ«ãƒãƒ¥ãƒ©4åŒ¹', types: ["fortress", "jabu"], subtypes: ["wallet", "child2"], child: "no" },
  ...
  { name: "Forest Temple Boss Key", jp: 'æ£®ã®ç¥žæ®¿ã®ãƒœã‚¹éƒ¨å±‹ã®ã‚«ã‚®', types: ["forest", "bosskey", "claimcheck", "quiver"], subtypes: ["mapcompass", "bosskey"], child: "no" },
...
bingoList[16] = [
  ...
  { name: "Frog's Heart Piece", jp: 'ã‚«ã‚¨ãƒ«ã®ãƒãƒ¼ãƒˆã®ã‹ã‘ã‚‰(åµã®æ­Œ)', types: ["forest", "child2"], subtypes: ["hearts", "songs"], child: "no" }
];
bingoList[17] = [
...
bingoList[18] = [
  ...
  { name: "Defeat Volvagia", jp: 'ãƒ´ã‚¡ãƒ«ãƒã‚¸ã‚¢æ’ƒç ´', types: ["fire"], subtypes: ["hearts", "mapcompass", "bosskey"], child: "no" },
...
bingoList[19] = [
  ...
  { name: "Beat the Fire Temple", jp: 'ç‚Žã®ç¥žæ®¿ã‚¯ãƒªã‚¢', types: ["fire", "forest"], subtypes: ["hearts", "bosskey", "mapcompass"], child: "no" },
...
bingoList[20] = [
  { name: "All 4 Wasteland/ Colossus area Skulltulas", jp: 'å¹»å½±ã®ç ‚æ¼ ãƒ»å·¨å¤§é‚ªç¥žåƒã‚¨ãƒªã‚¢ã®é»„é‡‘ã®ã‚¹ã‚¿ãƒ«ãƒãƒ¥ãƒ©4åŒ¹', types: ["spirit"], subtypes: ["child2", "wallet"], child: "no" },
...
bingoList[21] = [
  ...
  { name: "All 4 Market area Skulltulas", jp: 'åŸŽä¸‹ç”ºã‚¨ãƒªã‚¢ã®é»„é‡‘ã®ã‚¹ã‚¿ãƒ«ãƒãƒ¥ãƒ©4åŒ¹', types: ["forest", "child2"], subtypes: ["wallet"], subtypes: ["hearts"], child: "no" },
...
bingoList[22] = [
  ...
  { name: "Get to the end of Water Trial", jp: 'æ°´ã®çµç•Œã®æœ€å¾Œã®éƒ¨å±‹ã«åˆ°é”', types: ["ganon", "fire", "lightarrow"], subtypes: ["mapcompass", "bosskey"], child: "no" },
...
bingoList[24] = [
  ...
  { name: "Get to the end of Shadow Trial", jp: 'é—‡ã®çµç•Œã®æœ€å¾Œã®éƒ¨å±‹ã«åˆ°é”', types: ["ganon", "fire"], subtypes: ["mapcompass", "bosskey"], child: "no" }
];
bingoList[25] = [
  ...
  { name: "Get to the end of the Forest Trial", jp: 'æ£®ã®çµç•Œã®æœ€å¾Œã®éƒ¨å±‹ã«åˆ°é”', types: ["ganon", "zl", "firearrow"], child: "yes" }
];
