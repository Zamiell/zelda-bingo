...
router.get('/:seedChosen', function(req, res) {
	...
	if (isNormalInteger(req.param('seedChosen'))) {
		...
		raceCollection.find({}, {"sort": [['date', 'asc']]}, function(e, raceData) {
			...
			var rowData = {};
			rowData.good = {};
			rowData.good.row1 = (goalHash[card[1].name].goodPercent + goalHash[card[2].name].goodPercent + goalHash[card[3].name].goodPercent + goalHash[card[4].name].goodPercent + goalHash[card[5].name].goodPercent) / 5;
			rowData.good.row2 = (goalHash[card[6].name].goodPercent + goalHash[card[7].name].goodPercent + goalHash[card[8].name].goodPercent + goalHash[card[9].name].goodPercent + goalHash[card[10].name].goodPercent) / 5;
			rowData.good.row3 = (goalHash[card[11].name].goodPercent + goalHash[card[12].name].goodPercent + goalHash[card[13].name].goodPercent + goalHash[card[14].name].goodPercent + goalHash[card[15].name].goodPercent) / 5;
			rowData.good.row4 = (goalHash[card[16].name].goodPercent + goalHash[card[17].name].goodPercent + goalHash[card[18].name].goodPercent + goalHash[card[19].name].goodPercent + goalHash[card[20].name].goodPercent) / 5;
			rowData.good.row5 = (goalHash[card[21].name].goodPercent + goalHash[card[22].name].goodPercent + goalHash[card[23].name].goodPercent + goalHash[card[24].name].goodPercent + goalHash[card[25].name].goodPercent) / 5;
			rowData.good.col1 = (goalHash[card[1].name].goodPercent + goalHash[card[6].name].goodPercent + goalHash[card[11].name].goodPercent + goalHash[card[16].name].goodPercent + goalHash[card[21].name].goodPercent) / 5;
			rowData.good.col2 = (goalHash[card[2].name].goodPercent + goalHash[card[7].name].goodPercent + goalHash[card[12].name].goodPercent + goalHash[card[17].name].goodPercent + goalHash[card[22].name].goodPercent) / 5;
			rowData.good.col3 = (goalHash[card[3].name].goodPercent + goalHash[card[8].name].goodPercent + goalHash[card[13].name].goodPercent + goalHash[card[18].name].goodPercent + goalHash[card[23].name].goodPercent) / 5;
			rowData.good.col4 = (goalHash[card[4].name].goodPercent + goalHash[card[9].name].goodPercent + goalHash[card[14].name].goodPercent + goalHash[card[19].name].goodPercent + goalHash[card[24].name].goodPercent) / 5;
			rowData.good.col5 = (goalHash[card[5].name].goodPercent + goalHash[card[10].name].goodPercent + goalHash[card[15].name].goodPercent + goalHash[card[20].name].goodPercent + goalHash[card[25].name].goodPercent) / 5;
			rowData.good.tlbr = (goalHash[card[1].name].goodPercent + goalHash[card[7].name].goodPercent + goalHash[card[13].name].goodPercent + goalHash[card[19].name].goodPercent + goalHash[card[25].name].goodPercent) / 5;
			rowData.good.bltr = (goalHash[card[5].name].goodPercent + goalHash[card[9].name].goodPercent + goalHash[card[13].name].goodPercent + goalHash[card[17].name].goodPercent + goalHash[card[21].name].goodPercent) / 5;
			rowData.won = {};
			rowData.won.row1 = (goalHash[card[1].name].wonPercent + goalHash[card[2].name].wonPercent + goalHash[card[3].name].wonPercent + goalHash[card[4].name].wonPercent + goalHash[card[5].name].wonPercent) / 5;
			rowData.won.row2 = (goalHash[card[6].name].wonPercent + goalHash[card[7].name].wonPercent + goalHash[card[8].name].wonPercent + goalHash[card[9].name].wonPercent + goalHash[card[10].name].wonPercent) / 5;
			rowData.won.row3 = (goalHash[card[11].name].wonPercent + goalHash[card[12].name].wonPercent + goalHash[card[13].name].wonPercent + goalHash[card[14].name].wonPercent + goalHash[card[15].name].wonPercent) / 5;
			rowData.won.row4 = (goalHash[card[16].name].wonPercent + goalHash[card[17].name].wonPercent + goalHash[card[18].name].wonPercent + goalHash[card[19].name].wonPercent + goalHash[card[20].name].wonPercent) / 5;
			rowData.won.row5 = (goalHash[card[21].name].wonPercent + goalHash[card[22].name].wonPercent + goalHash[card[23].name].wonPercent + goalHash[card[24].name].wonPercent + goalHash[card[25].name].wonPercent) / 5;
			rowData.won.col1 = (goalHash[card[1].name].wonPercent + goalHash[card[6].name].wonPercent + goalHash[card[11].name].wonPercent + goalHash[card[16].name].wonPercent + goalHash[card[21].name].wonPercent) / 5;
			rowData.won.col2 = (goalHash[card[2].name].wonPercent + goalHash[card[7].name].wonPercent + goalHash[card[12].name].wonPercent + goalHash[card[17].name].wonPercent + goalHash[card[22].name].wonPercent) / 5;
			rowData.won.col3 = (goalHash[card[3].name].wonPercent + goalHash[card[8].name].wonPercent + goalHash[card[13].name].wonPercent + goalHash[card[18].name].wonPercent + goalHash[card[23].name].wonPercent) / 5;
			rowData.won.col4 = (goalHash[card[4].name].wonPercent + goalHash[card[9].name].wonPercent + goalHash[card[14].name].wonPercent + goalHash[card[19].name].wonPercent + goalHash[card[24].name].wonPercent) / 5;
			rowData.won.col5 = (goalHash[card[5].name].wonPercent + goalHash[card[10].name].wonPercent + goalHash[card[15].name].wonPercent + goalHash[card[20].name].wonPercent + goalHash[card[25].name].wonPercent) / 5;
			rowData.won.tlbr = (goalHash[card[1].name].wonPercent + goalHash[card[7].name].wonPercent + goalHash[card[13].name].wonPercent + goalHash[card[19].name].wonPercent + goalHash[card[25].name].wonPercent) / 5;
			rowData.won.bltr = (goalHash[card[5].name].wonPercent + goalHash[card[9].name].wonPercent + goalHash[card[13].name].wonPercent + goalHash[card[17].name].wonPercent + goalHash[card[21].name].wonPercent) / 5;
